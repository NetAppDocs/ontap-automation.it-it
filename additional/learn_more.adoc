...
+
https://www.netapp.tv/details/29670["Modernizza la gestione dello storage ONTAP con l'API REST ONTAP"^]

* Presentazione di Insight 2021 (31 minuti).
+
https://www.netapp.tv/details/28343["NetApp ONTAP: Risparmia tempo e semplifica l'utilizzo delle API REST"^]
