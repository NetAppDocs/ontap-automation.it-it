...
.Hub di automazione NetApp Console
IL https://console.netapp.com/automationHub["Hub di automazione NetApp Console"^] è disponibile tramite l'interfaccia utente web della Console. L'hub di automazione fornisce accesso a soluzioni pacchettizzate che possono aiutarti ad automatizzare la distribuzione e l'integrazione di ONTAP con altri prodotti. Vedere https://docs.netapp.com/us-en/netapp-automation/["Automazione di NetApp"^] per documentazione e maggiori informazioni.
