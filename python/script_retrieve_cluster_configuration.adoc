...
summary: È possibile eseguire lo script utilizzando Python 3 nella CLI per recuperare la configurazione del cluster ONTAP. 
---
= Script per recuperare la configurazione del cluster utilizzando la libreria client Python
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Il seguente script fornisce un semplice esempio di come utilizzare la libreria client Python. È possibile eseguire lo script utilizzando Python 3 nella CLI per recuperare la configurazione del cluster ONTAP.
