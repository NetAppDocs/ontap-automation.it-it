...
.Mappe LUN
Una mappa LUN è un'associazione tra una LUN e un initiator group. Questo tipo di risorsa è stato introdotto con ONTAP 9.6 e aggiornato con ONTAP 9.19.1.
