...
summary: 'Representational state Transfer (REST) è uno stile per la creazione di applicazioni web distribuite. Utilizza protocolli e standard mainstream per fornire una base flessibile per l"amministrazione dei cluster ONTAP.' 
---
