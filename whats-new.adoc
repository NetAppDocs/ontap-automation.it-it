...
Sicurezza:: È stata aggiunta una nuova `whoami` funzionalità per recuperare le informazioni relative a nome utente, ruolo e autorizzazioni dell'utente connesso. La funzionalità di autenticazione web (WebAuthn) è stata anch'essa migliorata.
