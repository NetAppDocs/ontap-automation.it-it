...
Mediatori del cluster:: È possibile effettuare il ping del servizio cloud BlueXP utilizzando l'API REST ONTAP . È anche possibile modificare la configurazione di un mediatore specifico utilizzando il metodo PATCH con un endpoint esistente.
