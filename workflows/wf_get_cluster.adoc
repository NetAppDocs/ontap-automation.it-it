...
In questo esempio viene illustrato come recuperare un singolo campo. Per ottenere l'intera configurazione del cluster, è necessario rimuovere `fields` parametro di query.
