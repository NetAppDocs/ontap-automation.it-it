...
NOTE: Per le release di ONTAP precedenti alla 9.9.1, puoi automatizzare l'amministrazione delle autorizzazioni SACL e DACL utilizzando la funzionalità di passthrough CLI. Vedi link:../migrate/migration-considerations.html["Considerazioni sulla migrazione"] per maggiori informazioni.
